...
import AdminBandCalendarManager from "@/src/components/AdminBandCalendarManager";
...
export const metadata: Metadata = {
  title: "Admin Band Calendar | Last Harvest Choir",
  description: "Admin calendar tools for managing services and rehearsals.",
  alternates: {
    canonical: "/admin/calendar",
  },
  openGraph: {
    title: "Admin Band Calendar | Last Harvest Choir",
    description: "Admin calendar tools for managing services and rehearsals.",
  ...
  return (
    <div className="min-h-screen flex flex-col bg-zinc-100/80 dark:bg-black">
      <main className="w-full max-w-6xl mx-auto px-3 sm:px-4 py-6 sm:py-8 flex-1">
        <AdminBandCalendarManager authorized={authorized} />
      </main>
