/**
 * Band calendar / schedule PDF only — DOM capture for {@link BandCalendarMonth}.
 * Not shared with setlist or contributions exports.
 */
import { toCanvas } from "html-to-image";
import { jsPDF } from "jspdf";

export type DownloadBandScheduleDomPdfOptions = {
  filename: string;
  scale?: number;
...
export async function downloadBandScheduleDomPdf(
  node: HTMLElement,
  options: DownloadBandScheduleDomPdfOptions
): Promise<void> {
